...
Blockly.Python['variables_incdec'] = function(block) {
  ...
  var argument0, operator;
  if (increment) {
    operator = ' += ';
    argument0 = Blockly.Python.valueToCode(block, 'DELTA', Blockly.Python.ORDER_ADDITIVE) || '0';
  } else {
    operator = ' -= ';
    argument0 = Blockly.Python.valueToCode(block, 'DELTA', Blockly.Python.ORDER_SUBTRACTIVE) || '0';
  }
